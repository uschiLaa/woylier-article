...
\caption{Plane to plane interpolation (left) and frame to frame interpolation (right). We used dog index for illustration purposes. Orientation of the data could affect the index value.}\label{fig:dogs}
\end{figure}
