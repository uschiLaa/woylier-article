...
This paper describes the R package \CRANpkg{woylier} which provides implementation of Givens interpolation path algorithm that can be used as an alternative interpolation method for tour. The algorithm implemented in the \CRANpkg{woylier} package is as described in Buja et al. (2005).
