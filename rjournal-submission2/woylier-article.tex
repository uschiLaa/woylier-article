...
{\centering \includegraphics[width=0.45\linewidth,alt={Two highlighted points on the surface of a 3D sphere (left) and 6D torus (right) connected by a path of points which are the interpolation steps, static view.}]{figures/sphere_static} \includegraphics[width=0.45\linewidth,alt={Two highlighted points on the surface of a 3D sphere (left) and 6D torus (right) connected by a path of points which are the interpolation steps, static view.}]{figures/torus_static} 
